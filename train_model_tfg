...
if __name__ == "__main__":
    ...
    dataset_demo_tr = {"name": "dataset_flexicar",
                       "im_dir": "../dataset_flexicar/train",
                       "gt_dir": "../dataset_flexicar/masks",
                       "im_ext": ".png",
                       "gt_ext": ".png",
                       "cache_dir": "../your-dataset/cache"}
    dataset_demo_vd = {"name": "dataset_flexicar",
                       "im_dir": "../dataset_flexicar/validation",
                       "gt_dir": "../dataset_flexicar/validation_mask",
                       "im_ext": ".png",
                       "gt_ext": ".png",
                       "cache_dir": "../dataset_flexicar/cache"}

    train_datasets = [dataset_demo_tr] ## users can create mutiple dictionary for setting a list of datasets as training set
    ...
    valid_datasets = [dataset_demo_vd] # dataset_vd, dataset_te1, dataset_te2, dataset_te3, dataset_te4] # and hypar["mode"] = "valid" for inference,
    ...
    if hypar["mode"] == "train":
        ...
        hypar["restore_model"] = "mytestpath.pth" ## name of the segmentation model weights .pth for resume training process from last stop or for the inferencing
    ...
    hypar["model_save_fre"] = 400 ## valid and save model weights every 2000 iterations

    hypar["batch_size_train"] = 8 ## batch size for training
    hypar["batch_size_valid"] = 1 ## batch size for validation and inferencing
    print("batch size: ", hypar["batch_size_train"])

    hypar["max_ite"] = 400 ## if early stop couldn't stop the training process, stop it by the max_ite_num
    hypar["max_epoch_num"] = 400 ## if early stop and max_ite couldn't stop the training process, stop it by the max_epoch_num
